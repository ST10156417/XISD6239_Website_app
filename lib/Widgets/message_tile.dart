  ...
  Widget build(BuildContext context){
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: widget.sentByMe ? Palette.deepsky : Colors.grey[700]
      ),
      child: Column(
        ...
        children: [
          Text(
            ...
            style: const TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: Palette.whiteblue, letterSpacing: -0.5),
          ),
          const SizedBox(
            height: 8,),
            Text(widget.message, textAlign: TextAlign.center, style: const TextStyle(fontSize: 16, color: Palette.whiteblue)),
